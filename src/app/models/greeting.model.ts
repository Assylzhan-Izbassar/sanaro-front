...
export const GREETING_DATA: Greeting[] = [
  ...
  new Greeting({
    ...
    infoTxt:
      'У нас будет пять вопросов чтобы лучше понять ситуацию в целом. После прохождение всех вопросов мы вам отправим чек-лист для ухода за здоровьем в ваш email.',
    buttonTxt: 'Приступим',
  }),
];
